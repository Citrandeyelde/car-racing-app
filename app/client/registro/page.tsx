...
export default function RegistroCliente() {
  ...
  return (
    <div className="max-w-md mx-auto my-12 p-8 bg-zinc-900 border-b-4 border-red-600 rounded-xl shadow-2xl text-white">
      <h2 className="text-3xl font-black italic uppercase mb-2">Registro de Cliente</h2>
      <p className="text-zinc-500 text-xs mb-8 tracking-widest uppercase italic">Sistema de Gestión Interna</p>

      <form onSubmit={handleRegistro} className="space-y-4">
        <div>
          <label className="text-[10px] font-bold text-zinc-400 uppercase">Nombre Completo</label>
          <input
        ...
        <div className="grid grid-cols-1 gap-4">
          <div>
            <label className="text-[10px] font-bold text-zinc-400 uppercase">Email Corporativo / Personal</label>
            <input
          ...
          <div>
            <label className="text-[10px] font-bold text-zinc-400 uppercase">Contraseña de Acceso</label>
            <input
        ...
        <div>
          <label className="text-[10px] font-bold text-zinc-400 uppercase">Teléfono de Contacto</label>
          <input
        ...
        <div>
          <label className="text-[10px] font-bold text-zinc-400 uppercase">Dirección de Despacho</label>
          <textarea
